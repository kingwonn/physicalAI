...
GROUPS = [
    ...
    ('技术', [('vla-models', 'vla-models.md'), ('world-models', 'world-models.md'), ('manipulation', 'manipulation.md'),
             ...
             ('data', 'data.md'), ('data-collection-devices', 'data-collection-devices.md'), ('data-foundry', 'data-foundry.md'), ('data-engine-roadmap', 'data-engine-roadmap.md'), ('lecun-worldmodels-rethink', 'lecun-worldmodels-rethink.md'), ('data-scaling-strategy', 'data-scaling-strategy.md'), ('tactile-hands', 'tactile-hands.md'), ('component-supply-chain', 'component-supply-chain.md'), ('evaluation', 'evaluation.md')]),
