#!/usr/bin/env python3
"""Render the physicalAI wiki (markdown) into a single-file HTML reader."""
import os, re, html, json, datetime

WIKI = '/home/builder/ai/cc/physicalAI/wiki'
OUT = '/tmp/claude-1001/-home-builder-ai-cc-physicalAI/78d7bb40-9179-4141-9e39-ffdea1c9ef2c/scratchpad/physicalai-wiki-reader.html'
...
GROUPS = [
    ...
    ('技术', [('vla-models', 'vla-models.md'), ('world-models', 'world-models.md'), ('manipulation', 'manipulation.md'),
             ('locomotion', 'locomotion.md'), ('simulation', 'simulation.md'), ('hardware', 'hardware.md'),
             ('data', 'data.md'), ('data-collection-devices', 'data-collection-devices.md'), ('data-foundry', 'data-foundry.md'), ('data-engine-roadmap', 'data-engine-roadmap.md'), ('lecun-worldmodels-rethink', 'lecun-worldmodels-rethink.md'), ('data-scaling-strategy', 'data-scaling-strategy.md'), ('data-engine-blueprint', 'data-engine-blueprint.md'), ('data-engine-first-principles', 'data-engine-first-principles.md'), ('case-mifeng', 'case-mifeng.md'), ('tactile-hands', 'tactile-hands.md'), ('component-supply-chain', 'component-supply-chain.md'), ('evaluation', 'evaluation.md')]),
    ...
    ('循环元数据', [('loop-log', '_meta/loop-log.md'), ('queue', '_meta/queue.md')]),
]
...
def md2html(text):
    lines = text.split('\n')
    out, i = [], 0
    in_ul, ul_depth = False, 0
    in_ol = False
    in_bq = False
    def close_lists():
        nonlocal in_ul, ul_depth, in_ol
        while ul_depth > 0:
...
page = '''<title>physicalAI 知识库阅读器</title>
<style>
:root{--paper:#F4F6F7;--panel:#FFF;--ink:#1A2329;--steel:#5B6B75;--line:#D8DFE3;--accent:#E8590C;--ok:#2B8A3E;--wait:#8A97A0;
--sans:-apple-system,"Segoe UI","Helvetica Neue","PingFang SC","Microsoft YaHei","Noto Sans CJK SC",sans-serif;
--mono:ui-monospace,"SF Mono","Cascadia Code",Consolas,Menlo,monospace}
html{background:var(--paper);scroll-behavior:smooth}
body{font-family:var(--sans);color:var(--ink);line-height:1.65;margin:0;display:flex;min-height:100vh}
...
<nav>
 <div class="brand">
  <p class="eb">Physical AI · LLM-Wiki</p>
  <h2>physicalAI 知识库</h2>
  <p>__TOTAL__ 页 · 全部对抗核查 · <a href="__CONSOLE__" target="_blank" rel="noopener">循环控制台 ↗</a></p>
 </div>
...
page = page.replace('__NAV__', navhtml).replace('__SECTIONS__', '\n'.join(sections)).replace('__TOTAL__', str(total - 2)).replace('__CONSOLE__', 'https://claude.ai/code/artifact/821047d4-fdd2-44a8-b26e-0034119ae56f')
open(OUT, 'w').write(page)
print('pages rendered:', total, '| bytes:', os.path.getsize(OUT))
