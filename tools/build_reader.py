...
GROUPS = [
    ...
    ('数采公司档案', [('case-genrobot', 'case-genrobot.md'), ('case-luming', 'case-luming.md'), ('case-morphic', 'case-morphic.md'), ('case-lingchu', 'case-lingchu.md'), ('case-jd-data', 'case-jd-data.md'), ('case-generalist', 'case-generalist.md'), ('data-companies-compare', 'data-companies-compare.md')]),
