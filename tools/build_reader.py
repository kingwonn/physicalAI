...
GROUPS = [
    ...
    ('数采公司档案', [('case-genrobot', 'case-genrobot.md'), ('case-luming', 'case-luming.md'), ('case-morphic', 'case-morphic.md'), ('case-lingchu', 'case-lingchu.md'), ('case-jd-data', 'case-jd-data.md'), ('case-generalist', 'case-generalist.md'), ('case-agilex', 'case-agilex.md'), ('case-paxini', 'case-paxini.md'), ('case-lightwheel', 'case-lightwheel.md'), ('case-galaxea', 'case-galaxea.md'), ('case-scale', 'case-scale.md'), ('data-companies-compare', 'data-companies-compare.md'), ('data-business-patterns', 'data-business-patterns.md')]),
