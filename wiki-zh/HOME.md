...
source: ../wiki/HOME.md
---
> physicalAI 知识库的带注释索引:共 38 个专题页面,覆盖全球具身智能(Physical AI)领域,
...
| [端侧具身智能大脑](on-device-brain.md) | 如何在端侧做好机器人大脑的深度技术+战略报告:双/三系统架构(S2 5-10Hz / S1 100-200Hz / S0 500Hz-1kHz)、云边分工、算力/模型优化、SoC 版图、功耗、软件栈、端侧模型、评价标尺、参考架构 + 模组厂读数 |
...
| [数据采集设备与装置](data-collection-devices.md) | 数据的硬件端:无本体(UMI/DexUMI/Dobb·E/数据手套/第一人称)vs 遥操作(ALOHA 2/VR/动捕/外骨骼)vs 真机 —— 60 个设备、三族权衡矩阵(成本/吞吐/本体差距/动作保真/可扩展)带批判裁决、各玩家设计 |
| [触觉感知与灵巧手](tactile-hands.md) | 灵巧手全景与价格、GelSight 谱系 vs 触觉单元(taxel)阵列、触觉数据集/模型、中国灵巧手量产经济学、为何灵巧硬件仍是短板 |
| [人形机器人零部件供应链](component-supply-chain.md) | BOM 成本与卡脖子地图 + 5 条子链供应商记分牌(谐波/RV 减速器、行星滚柱丝杠、无框电机、灵巧手、六维力/触觉传感器);国产化 vs 进口;丝杠是战略瓶颈;对模组厂(移远)的读数 |
...
| [ODM/EMS 友商全景](odm-competitors.md) | 16 家 ODM/EMS/模组厂的承诺度记分牌深度页(富士康/立讯/龙旗/蓝思/华勤/广达/广和通/美格…),四维度:产品线/投资/抢客户/落地;自造整机 vs 军火商两派 |
