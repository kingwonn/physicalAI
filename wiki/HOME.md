...
| [Data-Collection Devices & Rigs](data-collection-devices.md) | The hardware of data: embodiment-free (UMI/DexUMI/Dobb·E/gloves/egocentric) vs teleop (ALOHA 2/VR/mocap/exo) vs on-robot — 60 devices, a 3-family tradeoff matrix (cost/throughput/embodiment-gap/action-fidelity/scalability) with critical verdicts, per-player designs |
