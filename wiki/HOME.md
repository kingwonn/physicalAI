...
| [Intellectual History of Embodied Intelligence](intellectual-history.md) | The 70-year academic war behind today's routes: three lineages with verbatim primary quotes (cybernetics→symbolic→critics / embodiment school / learning+control confluence), the embodiment pendulum with historian footnotes, five great debates with receipts, X-pattern→academic-ancestor mapping (X2 = Moravec 1988 monetized — the paradox becomes an accounting identity; X4 = subsumption vindicated wearing the hat it opposed), and the honest verdict: weak embodied cognition winning, disembodied camp half-winning, symbol grounding reborn as economics — with dated dethrone clauses; 8 famous misquotations corrected against primary texts |
