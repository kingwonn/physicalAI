...
- [ ] **Unitree IPO pricing imminent (days)**: when offer price / subscription / listing date land (expected late 2026-07), refresh company-unitree.md, humanoid-robots.md, landscape-china.md, investment.md in one pass. Status 2026-07-04 ~15:30 CST: still no 发行安排/初步询价公告; SSE has 5 working days from the 07-02 registration to clear the issuance plan, so the offering could formally launch in the week of 2026-07-06. Monitor the SSE disclosure page (sse.com.cn auditId=2178; announcement PDFs under static.sse.com.cn code 002178) and 新股日历 aggregators for the 申购代码/申购日.
- [ ] **Unitree 2025 profit-measure reconciliation**: secondary reports conflict — ~RMB 600M 扣非 (+674%, SCMP round-up), RMB 591M "adjusted" (SCMP 2026-07-03, article 3359290), ~RMB 300M net ("净利3亿", STCN filing-stage headline 3735182), and a search-surfaced GAAP series (2023 −¥11.1M / 2024 ¥95.5M / 2025 ¥278M, unverified). Resolve GAAP vs 扣非 vs non-GAAP from the offering-stage 招股意向书 when it publishes; then fix company-unitree.md + landscape-china.md figures in one pass.
- [ ] New Yorker feature "Are Humanoid Robots Ready to Be Deployed?" (2026-07-06 issue) — read for open-problems/evaluation next refresh (surfaced via HN, loop(4)).
