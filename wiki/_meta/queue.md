...
- [ ] X Square Robot / AI² Robotics follow-up: WALL model family details, AlphaBot deployments, whether the RMB 20B valuations hold in next rounds. (07-12: Caixin 07-01 independently confirms >$2.8B — second source landed; next test = following round.)
...
- [ ] Korea follow-ups: investment.md fold-in of primary-verified program numbers (W881T chips / W550T AI DC / robot axis); Hyundai W42T Yeongnam hub — RESOLVED 07-12: ₩42T = Hyundai own 10-yr Ulsan AV/aerospace hub; ~₩102T = combined Samsung+Hyundai+SK Yeongnam package; ₩9T Saemangeum is a third scope; investment.md has no conflation, no edit needed; MSIT 3-year physical-AI export push; which vendors win robot data-factory slots.
