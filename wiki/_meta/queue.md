...
- [ ] **Unitree IPO pricing imminent (days)**: when offer price / subscription / listing date land (expected late 2026-07), refresh company-unitree.md, humanoid-robots.md, landscape-china.md, investment.md in one pass. Status 2026-07-04 ~17:00 CST (rechecked at market close): still no 发行安排/初步询价公告; Eastmoney 新股日历 API has no Unitree entry (latest scheduled STAR subscription: 泰诺麦博 787806 on 07-10); SSE audit record for auditId=2178 unchanged since 06-02 (currStatus 4, CITIC sponsor team listed). SSE has 5 working days from the 07-02 registration to clear the issuance plan → earliest formal launch week of 2026-07-06. Monitor the SSE disclosure page (sse.com.cn auditId=2178; announcement PDFs under static.sse.com.cn code 002178 — working JSON probe: query.sse.com.cn/statusAction.do?sqlId=SH_XM_LB&keyword=宇树 with Referer kcb.sse.com.cn; the GP_GPZCZ_SHXXPL doc-list sqlId returns empty) and 新股日历 aggregators (Eastmoney JSON: datacenter-web.eastmoney.com/api/data/v1/get?reportName=RPTA_APP_IPOAPPLY) for the 申购代码/申购日.
