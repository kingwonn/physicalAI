...
- [ ] Per-company deep pages, remaining: Physical Intelligence, NVIDIA robotics stack, Tesla Optimus (Figure ✅ loop(4): [company-figure.md](../company-figure.md); Unitree ✅ loop(4): [company-unitree.md](../company-unitree.md)).
...
- [ ] **Unitree IPO pricing imminent (days)**: when offer price / subscription / listing date land (expected late 2026-07), refresh company-unitree.md, humanoid-robots.md, landscape-china.md, investment.md in one pass.
