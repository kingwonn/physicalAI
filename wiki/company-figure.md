...
- **Delivery numbers are self-reported and mostly internal**: >350 built ≠ >350 sold; publicly confirmed external deployments are BMW (small fleet; exact count unverified) and Catalyst Brands (just starting). Compare Agility's published 65,000+ customer-site fleet hours — Figure publishes no equivalent reliability metrics.
