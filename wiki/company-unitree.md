...
- **Profitability**: 2025 adjusted (扣非) net profit ~RMB 600M, +674% YoY (implying ~RMB 78M in 2024); SCMP's IPO-approval coverage (2026-07-03) specifies **RMB 591M** adjusted; a Securities Times filing-stage headline put net profit at ~RMB 300M ("净利3亿") — the spread between GAAP, 扣非, and non-GAAP "adjusted" measures is unresolved pending the offering-stage prospectus (conflicting secondary reports). GAAP net margin ~18%, adjusted ~35% (single analyst source, unverified). Wang has claimed the company has been profitable since 2020 (company claim, unverified for pre-2022 years). This makes Unitree the rare profitable humanoid maker — UBTech lost RMB 790M in 2025; Western peers burn venture capital. See [Investment](investment.md).
