...
| NEO | 1X (NO/US) | ~1.68 m / 30 kg (~66 lb, corroborated by Witt's hands-on report) | 22-DoF hands; tendon-driven body | carries ~25 kg, lifts 68 kg | **$20K or $499/mo** | Consumer pre-orders (2025-10) — 10,000+ deposits, first five days (company-reported); US home deliveries 2026, teleop-assisted |
...
- **1X** (Norwegian-founded, Silicon Valley HQ since 2022) is the consumer front-runner on order volume: **10,000+ NEO deposits** at the $20K list price ($200 deposit) — booked within the first five days of the 2025-10 pre-order window per Forbes (company-reported figure — also relayed, not independently verified, by Stephen Witt's New Yorker reporting, 2026-07-06 issue). Witt's site visit (as of 2026-07) adds fresh operational color: **~800 staff** at the Silicon Valley industrial HQ across assembly, testing and R&D (reporter observation); production at a factory **near Oakland** (the Hayward plant opened 2026-05); NEO confirmed at **~66 lb (~30 kg)** — Witt picked it up in a "bridal carry" — and **22 dB** locomotion noise ("about the same volume as leaves rustling in a breeze"), both matching the official spec sheet; hand durability rigs showed a finger flex cycle counter at 2.86M. The 2026 home-delivery promise was reaffirmed on the record ("a promise we've made to the world, and a promise we've gotta keep" — product head Dar Sleeper), but the fluent kitchen demo Witt saw was VR-teleoperated and 1X declined to demo NEO's autonomy — see [Open problems](open-problems.md) for the reliability/teleop analysis and [Safety & regulation](safety-regulation.md) for the in-home privacy angle.
...
- https://www.newyorker.com/magazine/2026/07/06/are-humanoid-robots-ready-to-be-deployed — Stephen Witt site visit: 10,000+ deposits at $20K, ~800 HQ staff, ~66 lb weight, 22 dB, Oakland-area factory, 2026 delivery promise, teleoperated demo disclosure (read via Wayback snapshot)
- https://www.forbes.com/sites/johnkoetsier/2026/04/30/1x-kicks-off-full-scale-production-of-humanoid-robot-neo/ — Forbes: 10,000 NEO pre-orders booked in first five days of 2025-10 window (company-reported); full-scale production start 2026-04
