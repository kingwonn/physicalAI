...
As-of-dated; every row sourced (see [Sources](#sources)). Valuations are post-money unless noted.

| Company | Round | Amount | Valuation | Date | Lead / notable investors |
|---|---|---|---|---|---|
| [Figure AI](humanoid-robots.md) | Series C | >$1B | $39B | 2025-09 | Parkway Venture Capital; Brookfield, NVIDIA, Macquarie, Intel Capital, Salesforce, LG, Qualcomm Ventures |
| Figure AI | Series B | $675M | $2.6B | 2024-02 | Microsoft, OpenAI Startup Fund, NVIDIA, Bezos, Intel Capital |
| Skild AI | Series C | $1.4B | >$14B | 2026-01 | SoftBank; NVentures (Nvidia), Macquarie, Bezos Expeditions, Samsung, LG, Salesforce Ventures |
...
- **SoftBank → ABB Robotics, $5.375B** (agreed 2025-10-08; closing targeted mid-to-late 2026): SoftBank buys ABB's industrial-arm business (~7,000 employees, $2.28B 2024 revenue) as the anchor of a declared "physical AI" strategy, alongside stakes in Skild AI, Agile Robots, AutoStore and Berkshire Grey.
- **Tesla**: guided to ~$25B capex for 2026 (raised from >$20B at the 2026-04 Q1 call; roughly 3x the $8.5B spent in 2025), with a dedicated Optimus factory at Giga Texas and reported conversion of Fremont S/X lines to Optimus; volume production targets have repeatedly slipped and should be treated as aspirational (reported; see [Humanoid robots](humanoid-robots.md)). Not all of that capex is robotics — it also covers AI compute and robotaxi.
- **Nvidia** acts as the sector's kingmaker: direct or NVentures positions in Figure, Skild, and others, plus the GR00T/Isaac platform push — capital and compute flowing to whoever standardizes on its stack (see [Organizations](organizations.md), [Hardware](hardware.md)).
- **Alphabet** (CapitalG → Physical Intelligence; Google → Apptronik), **Amazon/Bezos** (Agility fund participation, Bezos in PI and Skild), **Samsung/LG/Qualcomm/Salesforce** all placed strategic bets in 2025–2026 rounds rather than building in-house at scale.

## Market-size forecasts — read with skepticism

| Source | Forecast | Horizon | Notes |
|---|---|---|---|
| Goldman Sachs | $38B humanoid TAM; ~1.4M units shipped | by 2035 | Revised ~6x upward in 2024-02 (from $6B), citing AI progress + ~40% BOM cost decline |
| Morgan Stanley | $5T humanoid ecosystem market | by 2050 | Includes robots, supply chain, services; some 2026 coverage cites an updated $7.5T figure (unverified) |
| Morgan Stanley (2026 outlook) | Hype persists near-term; startup shakeout risk; US–China gap widening in China's favor | 2026 | Tesla Optimus Gen 3 and big-tech entries flagged as catalysts (secondary coverage) |
| Industry analysts (e.g., MarketsandMarkets) | ~$6–10B humanoid market | by 2030 | Conservative near-term band; note the ~500x spread between 2030 and 2050 figures |

- The spread itself is the signal: 2030 estimates ($6–10B) vs 2050 estimates ($5T+) differ by orders of magnitude, and long-horizon "ecosystem" definitions inflate headline numbers.
- Every trillion-dollar figure assumes solved [manipulation](manipulation.md), cheap reliable [hardware](hardware.md), and data/[world-model](world-models.md) breakthroughs that remain [open problems](open-problems.md).

## Bubble watch

- **China's NDRC publicly warned of a bubble** in humanoid robotics (2025-11, spokeswoman Li Chao): >150 firms building near-identical robots, duplicative investment, and few proven commercial applications — a rare case of the chief planning agency talking down its own strategic sector.
- **Rodney Brooks** calls the idea that today's humanoids will learn human-level dexterity from video "pure fantasy thinking," predicts the hype will end in a "trough of disappointment," and expects successful robots to abandon the humanoid form (wheels, multiple arms, task-specific sensors) within ~15 years.
- **Revenue reality check** (as of 2026-07): almost no humanoid maker discloses meaningful revenue. Unitree's ~$235M (2025) is the largest disclosed pure-play figure; Skild claims ~$30M in a few months of 2025 (company claim, unverified); Figure ($39B), Skild ($14B), and PI ($11B reported) are priced on narrative. Industrial/logistics robotics earns real money today; humanoids largely do not.
- **Velocity as a warning sign**: Skild tripled to $14B in ~7 months; PI's reported mark would double in ~4 months (round unclosed); 1X sought a >12x markup ~20 months after its $820M round. These repricing speeds resemble 2021 crypto/AI-adjacent dynamics more than hardware-company fundamentals.
- Balanced view: unlike prior robot hype cycles, this one rides genuine [VLA-model](vla-models.md) progress and real Chinese manufacturing scale — the question is timing and which balance sheets survive the gap. See [History](history.md) for prior boom-bust cycles.

## Regional capital flows

**United States** (see [Landscape: USA](landscape-usa.md))
- Private mega-rounds dominate; capital concentrated in ~5 names (Figure, Skild, PI, Apptronik, Agility ≈ $4.5B+ raised across 2025–H1 2026).
- Strategic corporates (Nvidia, Alphabet, Amazon, Samsung, LG, Qualcomm, Salesforce) supply an outsized share of late-stage money — as much industrial positioning as financial investing.

**China** (see [Landscape: China](landscape-china.md))
- State capital leads: NDRC-backed robotics/AI/frontier VC fund designed to attract ~¥1T (~$138B) over 20 years (announced 2025-03); an $8.2B National AI Industry Investment Fund (from 2025-01); Beijing's ¥100B (~$14B) future-industries fund; >$26B in city-level humanoid/robotics funds (Beijing, Shenzhen, others) since late 2024 (per Morgan Stanley, corroborated by Jamestown).
- Embodied intelligence named one of four "future industries" in the 2025-03 government work report.
...
- https://www.figure.ai/news/series-c — Figure Series C: >$1B at $39B post-money, 2025-09-16, investor list, use of funds (primary).
- https://techcrunch.com/2025/09/16/figure-reaches-39b-valuation-in-latest-funding-round/ — Figure $39B round context; 15x step-up from $2.6B (2024-02).
- https://news.crunchbase.com/venture/robotics-startup-skild-ai-triples-valuation/ — Skild $1.4B at $14B (2026-01-14), SoftBank lead, prior Series B at $4.5B (records $135M; other coverage says ~$100M), ~$30M revenue claim.
...
- https://techfundingnews.com/humanoid-robot-maker-agility-robotics-to-secure-400m-at-1-75b-valuation-can-it-outspace-tesla-and-figure-ai/ — Agility ~$400M Series C, ~$2.1B post (2025), WP Global lead.
...
- https://www.myzaker.com/article/6a478df88e9f09665d7aa094 — 2026-07-03 rally, day after Unitree's registration approval: 超50只 stocks limit-up or up >10% (body phrasing; headline says "超50股涨停"), 绿的谐波 leading at +18.15%.
- https://finance.sina.com.cn/wm/2026-07-03/doc-inifpcva3674731.shtml — Sina count of the same rally: "40余股封涨停" (绿的谐波、拓普集团 et al.) plus dozens more up >10%.
- https://www.stcn.com/article/detail/3335199.html — 首开股份 ~0.3% indirect Unitree stake via Jinshi Growth fund; 2025-09 limit-up streak on the proxy trade.
...
- https://www.scmp.com/tech/big-tech/article/3317741/robot-maker-agibot-seeks-stake-shanghai-listed-firm-potential-back-door-listing-move — AgiBot's Shangwei New Materials stake / backdoor-listing read.
...
- https://www.cnbc.com/2025/04/29/how-to-play-a-5-trillion-market-for-humanoid-robots-by-2050.html — Morgan Stanley forecast coverage and scope caveats.
- https://futurism.com/future-society/humanoid-robot-financial-bubble — investor bubble warnings; NDRC caution; Brooks's "trough of disappointment" quote.
- https://techcrunch.com/2025/09/26/famed-roboticist-says-humanoid-robot-bubble-is-doomed-to-burst/ — Brooks's "pure fantasy thinking" critique of video-trained dexterity; prediction that winning designs abandon the humanoid form.
- https://www.eweek.com/news/china-warns-humanoid-robot-firms/ — NDRC bubble warning (2025-11): Li Chao on >150 near-identical humanoid programs and product duplication.
- https://www.forbes.com/sites/annatong/2025/12/31/2025-another-year-of-humanoid-hype/ — end-2025 hype retrospective; revenue-vs-narrative gap.
