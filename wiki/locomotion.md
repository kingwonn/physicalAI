...
- **Speed records** (as of 2026-04): Unitree H1 sprinted **10 m/s (~22.4 mph; peak 10.1 m/s past a timing gate)** on 2026-04-11, matching the 10 m/s mark claimed by **MirrorMe's "Bolt"** on 2026-02-02. MirrorMe Technology is a real Shanghai startup (founded 2024-05, Zhejiang University spinout; earlier built the **Black Panther II** quadruped — ~0.63 m, ~38 kg, spring-loaded knees — that ran a televised 100 m in 13.17 s, racing Olympic 100 m champion Noah Lyles in a MrBeast video, 2025-11, and holds the claimed quadruped peak-speed record: a 2025-11-26 company release cited 13.2 m/s, up from 10.3 m/s a month earlier, and a 2025-12-25 company video pushed the claim to **13.4 m/s** — all from company-provided footage with no third-party timing, so the numeric peak remains unverified); Bolt is a 175 cm / 75 kg humanoid, and its 10 m/s was shown in a **promotional treadmill demo** (a founder racing it side-by-side), *not* an outdoor track or independently timed run. Both marks are company-reported from company-provided footage — widely re-reported by outlets (CGTN, Interesting Engineering, CnEVPost) but with no third-party timing (numeric claims still unverified). H1's own prior record was 3.3 m/s (2024-03). Software/control gains, not new hardware, credited.
- **Boston Dynamics converted**: partnered with the Robotics & AI Institute (2025-02, press release) on a shared RL training pipeline for electric Atlas; RAI's open Spot pipeline (Isaac Lab, ICRA 2025) hit **5.2 m/s zero-shot — ~3x Spot's default top speed** — using distribution-matching (Wasserstein/MMD + CMA-ES) to tune sim parameters. The production electric Atlas (unveiled CES 2026-01-05; the Forbes 2026-07-02 piece describes this CES model) continues the sim+RL pipeline with "order of magnitude" simpler hardware — see [BD deep dive](company-bostondynamics.md).
...
- Commercial proof: thousands of Spot and ANYmal units run learned or hybrid controllers in industrial inspection; Unitree self-reports 5,500+ humanoids shipped in 2025 (IPO-prospectus figure; Omdia's independent count is ~4,200 — the gap is a methodology dispute over what counts as a humanoid), all with RL locomotion as standard firmware (as of 2026, see [investment](investment.md) and [organizations](organizations.md)).
...
- **Energy efficiency**: standard velocity-tracking RL policies with no energy term tend to be inefficient — they exhibit high-frequency foot tapping/skating (Fu et al. show this directly in ablation) — but learned policies that put energy in the reward *beat* model-based baselines. Hwangbo et al. 2019 report a learned ANYmal controller using ~20% less mechanical power (78.1 vs 97.3 W) and 23–36% less torque than a model-based controller at matched speeds; Fu et al. (CoRL 2021) report an energy-minimizing A1 policy ~50% more energy-efficient than convex MPC when walking (30.7 vs 87.0 J/m energy-per-meter; trot 41.2 vs 77.2; bounce 90.7 vs 93.9). Cost-of-transport is still reported inconsistently — units and baselines vary across papers (some report J/m, some W, some dimensionless CoT), making cross-system comparison hard. A rare dimensionless datapoint: Wang et al. (FITEE 2025, 26(9):1679–1691) trained walk/trot/gallop policies plus a learned gait selector on small 12-DoF quadrupeds (Jueying Lite3, Unitree A1) and report their multigait policy averaging **CoT = 0.4306** across feasible velocity commands — beating an FSM gait-switching baseline (0.4531) and every single-gait policy (0.45–0.72) while holding 100% traversal success on fractal, slope, and discrete terrains (simulation evaluation; policies designed for sim-to-real transfer).
...
- https://www.humanoidsdaily.com/news/unitree-h1-reclaims-speed-record-with-blistering-10-m-s-sprint — Unitree H1 10 m/s sprint (2026-04-11), peak 10.1 m/s past a timing gate; prior 3.3 m/s record; MirrorMe Bolt context.
- https://cnevpost.com/2026/02/03/mirrorme-unveils-worlds-fastest-humanoid-robot-bolt/ — MirrorMe Technology (Shanghai, founded 2024-05, Zhejiang University team); Bolt unveiled 2026-02-02/03, 175 cm / 75 kg, 10 m/s in company footage; Black Panther II quadruped background.
- https://interestingengineering.com/ai-robotics/fastest-humanoid-robot-bolt-unveiled — independent coverage confirming Bolt's 10 m/s was a promotional treadmill demo (founder raced it side-by-side), company-provided footage, no third-party timing.
- https://markets.financialcontent.com/wral/article/getnews-2025-11-26-black-panther-ii-the-worlds-fastest-robot-dog-racing-a-world-champion-in-mrbeasts-latest-video-from-chinas-mirrorme-technology — MirrorMe press release (2025-11-26): Black Panther II peak 13.2 m/s (from 10.3 m/s in 30 days), MrBeast race vs Noah Lyles ("narrowly lost"); promotional source.
- https://www.aparobot.com/robots/black-panther-ii — Black Panther II spec page (manufacturer-verified data): 100 m in 13.17 s; demonstrated 9.7 m/s with internal tests reportedly 10–13 m/s.
- https://x.com/XRoboHub/status/2004194422817542449 — re-report of MirrorMe's 2025-12-25 company video claiming a 13.4 m/s peak (company footage only, unverified).
- https://doi.org/10.1631/FITEE.2401070 — Wang et al., "Efficient learning of robust multigait quadruped locomotion for minimizing the cost of transport" (FITEE 2025, 26(9):1679–1691): CoTavg 0.4306 vs FSM 0.4531 and single-gait 0.45–0.72 (Table 6); Jueying Lite3 + Unitree A1; Isaac Gym training.
- https://arxiv.org/abs/1901.08652 — Hwangbo et al., "Learning Agile and Dynamic Motor Skills" (Science Robotics 2019): learned ANYmal used less torque (8.23 vs 11.7 N·m) and mechanical power (78.1 vs 97.3 W) than model-based controller, 23–36% less torque by velocity, broke ANYmal speed record by 25%.
- https://proceedings.mlr.press/v164/fu22a/fu22a.pdf — Fu et al., "Minimizing Energy Consumption Leads to the Emergence of Gaits" (CoRL 2021): A1 energy-per-meter vs convex MPC (Table 2), walking ~50% more efficient; ablation showing non-energy-optimized policies tap at high frequency.
...
- https://autonews.gasgoo.com/articles/market-industry/annual-champion-changes-hands-unitree-announces-over-5500-humanoid-robot-shipments-2014711162140991489 — Unitree prospectus self-reported 5,500+ humanoids shipped 2025 vs Omdia's independent ~4,200 count; methodology dispute over robot classification.
